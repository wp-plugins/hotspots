...
Some limitations:
1. Currently does not cater for responsive design
1. Websites must be HTML5 compliant and the heat map can only be viewed in a browser which supports HTML5 canvas
1. This plugin should only be used to assist usability testing, not used in production. When turned on, an additional server request is made for each mouse click.
