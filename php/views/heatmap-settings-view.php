...
class HUT_Heatmap_Settings_View {
	...
	public static function field_heatmapjs() {
		$heat_map_settings = (array) get_option( HUT_Common::HEAT_MAP_SETTINGS_KEY );
		$option_value = $heat_map_settings[HUT_Common::USE_HEATMAPJS_OPTION];
		?>
		<input type="checkbox" name="<?php echo HUT_Common::HEAT_MAP_SETTINGS_KEY; ?>[<?php echo HUT_Common::USE_HEATMAPJS_OPTION; ?>]" value="true" <?php checked(true, $option_value, true); ?> />
		<p class="description">Use <a href="http://www.patrick-wied.at/static/heatmapjs/">heatmap.js</a> library to draw the heatmap. Otherwise, plot the mouse clicks and touch screen taps with coloured heat values.</p>
		<?php 
	}
	
	public static function field_hot_value() {
		$heat_map_settings = (array) get_option( HUT_Common::HEAT_MAP_SETTINGS_KEY );
		$option_value = $heat_map_settings[HUT_Common::HOT_VALUE_OPTION];
		?>
		<input type="text" name="<?php echo HUT_Common::HEAT_MAP_SETTINGS_KEY; ?>[<?php echo HUT_Common::HOT_VALUE_OPTION; ?>]" value="<?php echo esc_attr( $option_value ); ?>" />&nbsp;(must be greater than 0)
	...
	public static function field_spot_radius() {
		$heat_map_settings = (array) get_option( HUT_Common::HEAT_MAP_SETTINGS_KEY );
		$option_value = $heat_map_settings[HUT_Common::SPOT_RADIUS_OPTION];
		?>
		<input type="text" name="<?php echo HUT_Common::HEAT_MAP_SETTINGS_KEY; ?>[<?php echo HUT_Common::SPOT_RADIUS_OPTION; ?>]" value="<?php echo esc_attr( $option_value ); ?>" />&nbsp;(between 1 and 25)
	...
	public static function field_spot_opacity() {
		$heat_map_settings = (array) get_option( HUT_Common::HEAT_MAP_SETTINGS_KEY );
		$option_value = $heat_map_settings[HUT_Common::SPOT_OPACITY_OPTION];
		?>
		<input type="text" name="<?php echo HUT_Common::HEAT_MAP_SETTINGS_KEY; ?>[<?php echo HUT_Common::SPOT_OPACITY_OPTION; ?>]" value="<?php echo esc_attr( $option_value ); ?>" />&nbsp;(between 0.0 and 1.0)
	...
	public static function field_ignore_width() {
		$heat_map_settings = (array) get_option( HUT_Common::HEAT_MAP_SETTINGS_KEY );
		$option_value = $heat_map_settings[HUT_Common::IGNORE_WIDTH_OPTION];
		?>
		<input type="checkbox" name="<?php echo HUT_Common::HEAT_MAP_SETTINGS_KEY; ?>[<?php echo HUT_Common::IGNORE_WIDTH_OPTION; ?>]" value="true" <?php checked(true, $option_value, true); ?> />
	...
	public static function field_ignore_device() {
		$heat_map_settings = (array) get_option( HUT_Common::HEAT_MAP_SETTINGS_KEY );
		$option_value = $heat_map_settings[HUT_Common::IGNORE_DEVICE_OPTION];
		?>
		<input type="checkbox" name="<?php echo HUT_Common::HEAT_MAP_SETTINGS_KEY; ?>[<?php echo HUT_Common::IGNORE_DEVICE_OPTION; ?>]" value="true" <?php checked(true, $option_value, true); ?> />
	...
	public static function field_ignore_os() {
		$heat_map_settings = (array) get_option( HUT_Common::HEAT_MAP_SETTINGS_KEY );
		$option_value = $heat_map_settings[HUT_Common::IGNORE_OS_OPTION];
		?>
		<input type="checkbox" name="<?php echo HUT_Common::HEAT_MAP_SETTINGS_KEY; ?>[<?php echo HUT_Common::IGNORE_OS_OPTION; ?>]" value="true" <?php checked(true, $option_value, true); ?> />
	...
	public static function field_ignore_browser() {
		$heat_map_settings = (array) get_option( HUT_Common::HEAT_MAP_SETTINGS_KEY );
		$option_value = $heat_map_settings[HUT_Common::IGNORE_BROWSER_OPTION];
		?>
		<input type="checkbox" name="<?php echo HUT_Common::HEAT_MAP_SETTINGS_KEY; ?>[<?php echo HUT_Common::IGNORE_BROWSER_OPTION; ?>]" value="true" <?php checked(true, $option_value, true); ?> />
	...
	public static function field_width_allowance() {
		$heat_map_settings = (array) get_option( HUT_Common::HEAT_MAP_SETTINGS_KEY );
		$option_value = $heat_map_settings[HUT_Common::WIDTH_ALLOWANCE_OPTION];
		?>
		<input type="text" name="<?php echo HUT_Common::HEAT_MAP_SETTINGS_KEY; ?>[<?php echo HUT_Common::WIDTH_ALLOWANCE_OPTION; ?>]" value="<?php echo esc_attr( $option_value ); ?>" />&nbsp;pixels (between 0 and 20)
	...
	public static function sanitize_heat_map_settings($input) {
		...
		if ( isset( $input[HUT_Common::IGNORE_OS_OPTION] ) && $input[HUT_Common::IGNORE_OS_OPTION] == "true")
			$input[HUT_Common::IGNORE_OS_OPTION] = true;
		else
			$input[HUT_Common::IGNORE_OS_OPTION] = false;
		
		// Ignore browser family option
		if ( isset( $input[HUT_Common::IGNORE_BROWSER_OPTION] ) && $input[HUT_Common::IGNORE_BROWSER_OPTION] == "true")
			$input[HUT_Common::IGNORE_BROWSER_OPTION] = true;
		else
			$input[HUT_Common::IGNORE_BROWSER_OPTION] = false;
