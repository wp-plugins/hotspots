...
class HUT_General_Settings_View {
	
	public static function section_general_desc() {
	}

	public static function field_save_click_tap() {
		$general_settings = (array) get_option( HUT_Common::GENERAL_SETTINGS_KEY );
		$option_value = $general_settings[HUT_Common::SAVE_CLICK_TAP_OPTION];
		?>
		<input type="checkbox" name="<?php echo HUT_Common::GENERAL_SETTINGS_KEY; ?>[<?php echo HUT_Common::SAVE_CLICK_TAP_OPTION; ?>]" value="true" <?php checked(true, $option_value, true); ?>/>
	...
	public static function field_draw_heat_map_enabled() {
		$general_settings = (array) get_option( HUT_Common::GENERAL_SETTINGS_KEY );
		$option_value = $general_settings[HUT_Common::DRAW_HEAT_MAP_ENABLED_OPTION];
		?>
		<input type="checkbox" name="<?php echo HUT_Common::GENERAL_SETTINGS_KEY; ?>[<?php echo HUT_Common::DRAW_HEAT_MAP_ENABLED_OPTION; ?>]" value="true" <?php checked(true, $option_value, true ); ?>/>
	...
	public static function field_debug() {
		$general_settings = (array) get_option( HUT_Common::GENERAL_SETTINGS_KEY );
		$option_value = $general_settings[HUT_Common::DEBUG_OPTION];
		?>
		<input type="checkbox" name="<?php echo HUT_Common::GENERAL_SETTINGS_KEY; ?>[<?php echo HUT_Common::DEBUG_OPTION; ?>]" value="true" <?php checked(true, $option_value, true); ?>/>
	...
	public static function field_save_ajax_actions() {
		$general_settings = (array) get_option( HUT_Common::GENERAL_SETTINGS_KEY );
		$option_value = $general_settings[HUT_Common::SAVE_AJAX_ACTIONS_OPTION];
		?>
		<input type="checkbox" name="<?php echo HUT_Common::GENERAL_SETTINGS_KEY; ?>[<?php echo HUT_Common::SAVE_AJAX_ACTIONS_OPTION; ?>]" value="true" <?php checked(true, $option_value, true); ?>/>
	...
	public static function field_save_custom_events() {
		$general_settings = (array) get_option( HUT_Common::GENERAL_SETTINGS_KEY );
		$option_value = $general_settings[HUT_Common::SAVE_CUSTOM_EVENTS_OPTION];
		?>
		<input type="checkbox" name="<?php echo HUT_Common::GENERAL_SETTINGS_KEY; ?>[<?php echo HUT_Common::SAVE_CUSTOM_EVENTS_OPTION; ?>]" value="true" <?php checked(true, $option_value, true); ?>/>
	...
	public static function field_save_page_views() {
		$general_settings = (array) get_option( HUT_Common::GENERAL_SETTINGS_KEY );
		$option_value = $general_settings[HUT_Common::SAVE_PAGE_VIEWS_OPTION];
		?>
		<input type="checkbox" name="<?php echo HUT_Common::GENERAL_SETTINGS_KEY; ?>[<?php echo HUT_Common::SAVE_PAGE_VIEWS_OPTION; ?>]" value="true" <?php checked(true, $option_value, true); ?>/>
	...
	public static function sanitize_general_settings($input) {
		...
		if ( isset( $input[HUT_Common::SAVE_CUSTOM_EVENTS_OPTION] ) && $input[HUT_Common::SAVE_CUSTOM_EVENTS_OPTION] == "true")
			$input[HUT_Common::SAVE_CUSTOM_EVENTS_OPTION] = true;
		else
			$input[HUT_Common::SAVE_CUSTOM_EVENTS_OPTION] = false;
		
		// Save page views option
		if ( isset( $input[HUT_Common::SAVE_PAGE_VIEWS_OPTION] ) && $input[HUT_Common::SAVE_PAGE_VIEWS_OPTION] == "true")
			$input[HUT_Common::SAVE_PAGE_VIEWS_OPTION] = true;
		else
			$input[HUT_Common::SAVE_PAGE_VIEWS_OPTION] = false;
